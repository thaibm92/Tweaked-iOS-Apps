...
**Tweaks injected into iOS apps.** _(last update: 05/feb/23)_
...
[Add source to AltStore/SideStore/ESign](https://raw.githubusercontent.com/purp0s3/Tweaked-iOS-Apps/main/zSource/apps.json). (thanks to @hieuddo)
